        ...
        <td class="pr-6">
            <div class="relative flex justify-end items-center">
                ...
                <div v-show="dropdownOpen"
                    class="mx-3 origin-top-right absolute right-7 top-0 w-48 mt-1 rounded-md shadow-lg z-20">
            ...
            confirmDelete() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.delete('/accounts/' + this.task.account_id + '/tasks/' + this.task.id).then(()=>{
                            Swal.fire(
                                'Deleted!',
